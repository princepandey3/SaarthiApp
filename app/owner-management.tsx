...
const MANAGEMENT_OPTIONS: ManagementOption[] = [
  {
    ...
    subtitle: 'Register a new owner',
    icon: <UserPlus size={24} color="#22c55e" />,
    backgroundColor: '#dcfce7',
  },
  {
    id: 'modify',
    title: 'Modify Owner Details',
    subtitle: 'Update existing owner information',
    icon: <UserCog size={24} color="#22c55e" />,
    backgroundColor: '#dcfce7',
  },
];
...
export default function OwnerManagement() {
  ...
  const handleOptionPress = (option: ManagementOption) => {
    Alert.alert('Owner Management', `Opening ${option.title}`);
  };
        ...
        <View style={styles.optionsContainer}>
          {MANAGEMENT_OPTIONS.map((option, index) => (
            <TouchableOpacity
              ...
              style={[
                styles.optionItem,
                index === MANAGEMENT_OPTIONS.length - 1 && styles.lastOptionItem
              ]}
